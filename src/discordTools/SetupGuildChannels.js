...
module.exports = async (client, guild, category) => {
    ...
    await addTextChannel(client.intlGet(guild.id, 'channelNameCommandsGuide'), 'commandsGuide', client, guild, category, false);
    ...
    await addTextChannel(client.intlGet(guild.id, 'channelNameRecycler'), 'recycler', client, guild, category);
